...
def create(
    ...
    truncate_overlength_prompt: Optional[int] = 77,
...
def create(**kwargs) -> Optional['DocumentArray']:
    ...
    :param truncate_overlength_prompt: [DiscoArt] all CLIP models use 77 as the context length. Set this parameter to truncate the prompt to the length of the model's context length.
