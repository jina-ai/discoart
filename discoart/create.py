...
def create(
    ...
    clip_sequential_evaluate: Optional[bool] = False,
...
def create(**kwargs) -> Optional['DocumentArray']:
    ...
    :param skip_event: A multiprocessing.Event that once set, will skip the current run and move to the next run as defined in `n_batches`.
    ...
    :param stop_event: A multiprocessing.Event that once set, will stop all generation of `n_batches` and immediately return from `create`.
